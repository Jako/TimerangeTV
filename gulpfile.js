...
gulp.task('scripts-mgr', function () {
    return gulp.src([
        ...
        .pipe(concat('timerangetv.min.js'))
        .pipe(uglify())
        .pipe(header(banner + '\n', {pkg: pkg}))
        .pipe(gulp.dest('assets/components/timerangetv/js/mgr/'))
});
...
gulp.task('sass-mgr', function () {
    return gulp.src([
        ...
        .pipe(footer('\n' + banner, {pkg: pkg}))
        .pipe(gulp.dest('assets/components/timerangetv/css/mgr/'))
});

gulp.task('images-mgr', function () {
    return gulp.src('./source/img/**/*.+(png|jpg|gif|svg)')
        .pipe(gulp.dest('assets/components/timerangetv/img/'));
});
...
gulp.task('bump-options', function () {
    return gulp.src([
        'core/components/timerangetv/elements/tv/input/tpl/timerange.options.tpl'
    ], {base: './'})
