...
<script type="text/javascript">
    ...
    MODx.load({
        ...
        items: [{
            ...
            html: '<img width="133" height="40" src="' + TimerangeTV.config.assetsUrl + 'img/treehill-studio-small.png"' + ' srcset="' + TimerangeTV.config.assetsUrl + 'img/treehill-studio-small@2x.png 2x" alt="Treehill Studio">',
            listeners: {
                afterrender: function (component) {
                    component.getEl().select('img').on('click', function () {
                        var msg = '<span style="display: inline-block; text-align: center">© 2012-2019 by <a href="https://oostdesign.com/" target="_blank">OostDesign</a><br>' +
                            ...
                            '© 2019 by <a href="https://treehillstudio.com" target="_blank">treehillstudio.com</a></span>';
                        Ext.Msg.show({
