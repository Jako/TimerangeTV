...
switch ($options[xPDOTransport::PACKAGE_ACTION]) {
    case xPDOTransport::ACTION_INSTALL:
        $output .= '<h2>Install TimerangeTV</h2>

        <p>Thanks for installing TimerangeTV. This open source extra was
    ...
    case xPDOTransport::ACTION_UPGRADE:
        ...
        <p>TimerangeTV will be upgraded. This open source extra was developped by
